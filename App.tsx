...
const App: React.FC = () => {
  ...
  return (
    ...
    >
      {/* Floating Language Toggle for development/testing visibility */}
      <button 
      ...
      {/* Main Content with conditional blur - reduced further to blur-[2px] */}
      <div className={`flex-1 overflow-y-auto pb-24 px-4 pt-6 space-y-6 transition-all duration-300 ${isModalOpen ? 'blur-[2px] pointer-events-none' : ''}`}>
        <Header t={t} />
        <BalanceSection t={t} />
        <ActionButtons t={t} />
